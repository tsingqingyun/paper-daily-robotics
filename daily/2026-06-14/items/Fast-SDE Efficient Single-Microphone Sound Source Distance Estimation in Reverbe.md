...
`python3 scripts/start_ai_deep_read.py --vault "." --note "30_Updates/2026-06-14/Fast-SDE Efficient Single-Microphone Sound Source Distance Estimation in Reverbe.md" --level full`
