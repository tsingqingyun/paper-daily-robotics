...
`python3 scripts/start_ai_deep_read.py --vault "." --note "30_Updates/2026-06-14/Traceable Virtual Sea Trials in the Marine Robotics Unity Simulator for Manoeuvr.md" --level full`
