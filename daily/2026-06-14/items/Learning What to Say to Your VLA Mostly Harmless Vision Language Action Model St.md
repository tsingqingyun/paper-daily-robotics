...
`python3 scripts/start_ai_deep_read.py --vault "." --note "30_Updates/2026-06-14/Learning What to Say to Your VLA Mostly Harmless Vision Language Action Model St.md" --level full`
