...
`python3 scripts/start_ai_deep_read.py --vault "." --note "30_Updates/2026-06-14/WT-UMI Tactile-based Whole-Body Manipulation via Force-Supervised Contact-Aware.md" --level full`
