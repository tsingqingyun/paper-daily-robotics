...
`python3 scripts/start_ai_deep_read.py --vault "." --note "30_Updates/2026-06-14/EgoEngine From Egocentric Human Videos to High-Fidelity Dexterous Robot Demonstr.md" --level full`
