...
`python3 scripts/start_ai_deep_read.py --vault "." --note "30_Updates/2026-06-15/Self-Improving VLA Policies Selected Diffusion Noise for Spurious-Robust Action.md" --level full`
