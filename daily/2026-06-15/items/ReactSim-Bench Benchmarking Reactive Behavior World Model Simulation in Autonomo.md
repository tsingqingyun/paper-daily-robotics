...
`python3 scripts/start_ai_deep_read.py --vault "." --note "30_Updates/2026-06-15/ReactSim-Bench Benchmarking Reactive Behavior World Model Simulation in Autonomo.md" --level full`
