...
`python3 scripts/start_ai_deep_read.py --vault "." --note "30_Updates/2026-06-15/SIMMER Benchmarking Latent Failures in LLM Executable Planning with a World Mode.md" --level full`
