...
`python3 scripts/start_ai_deep_read.py --vault "." --note "30_Updates/2026-06-15/Kine2Go Kinematic dataset for the Unitree Go2 robot with diverse gaits and motio.md" --level full`
