...
`python3 scripts/start_ai_deep_read.py --vault "." --note "30_Updates/2026-06-15/An Attention-based Model for Robust Forecasting with Missing Modality.md" --level full`
