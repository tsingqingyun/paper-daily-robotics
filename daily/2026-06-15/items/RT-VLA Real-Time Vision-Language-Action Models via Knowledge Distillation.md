...
`python3 scripts/start_ai_deep_read.py --vault "." --note "30_Updates/2026-06-15/RT-VLA Real-Time Vision-Language-Action Models via Knowledge Distillation.md" --level full`
