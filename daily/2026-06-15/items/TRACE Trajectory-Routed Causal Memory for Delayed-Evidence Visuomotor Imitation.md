...
`python3 scripts/start_ai_deep_read.py --vault "." --note "30_Updates/2026-06-15/TRACE Trajectory-Routed Causal Memory for Delayed-Evidence Visuomotor Imitation.md" --level full`
