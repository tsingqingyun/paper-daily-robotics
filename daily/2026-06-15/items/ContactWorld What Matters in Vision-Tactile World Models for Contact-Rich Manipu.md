...
`python3 scripts/start_ai_deep_read.py --vault "." --note "30_Updates/2026-06-15/ContactWorld What Matters in Vision-Tactile World Models for Contact-Rich Manipu.md" --level full`
