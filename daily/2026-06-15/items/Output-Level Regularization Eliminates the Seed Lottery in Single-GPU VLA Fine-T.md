...
`python3 scripts/start_ai_deep_read.py --vault "." --note "30_Updates/2026-06-15/Output-Level Regularization Eliminates the Seed Lottery in Single-GPU VLA Fine-T.md" --level full`
