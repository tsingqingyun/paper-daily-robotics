...
`python3 scripts/start_ai_deep_read.py --vault "." --note "30_Updates/2026-06-20/FlowMaps Modeling Long-Term Multimodal Object Dynamics with Flow Matching.md" --level full`
