...
`python3 scripts/start_ai_deep_read.py --vault "." --note "30_Updates/2026-06-20/Fail-RAG A Retrieval Augmented Generation Informed Framework for Robot Failure I.md" --level full`
