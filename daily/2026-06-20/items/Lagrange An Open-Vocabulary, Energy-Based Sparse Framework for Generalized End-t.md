...
`python3 scripts/start_ai_deep_read.py --vault "." --note "30_Updates/2026-06-20/Lagrange An Open-Vocabulary, Energy-Based Sparse Framework for Generalized End-t.md" --level full`
