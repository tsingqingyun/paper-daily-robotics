...
`python3 scripts/start_ai_deep_read.py --vault "." --note "30_Updates/2026-06-20/DF-ExpEnse Diffusion Filtered Exploration for Sample Efficient Finetuning.md" --level full`
