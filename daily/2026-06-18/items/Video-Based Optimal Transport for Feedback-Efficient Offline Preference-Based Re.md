...
`python3 scripts/start_ai_deep_read.py --vault "." --note "30_Updates/2026-06-18/Video-Based Optimal Transport for Feedback-Efficient Offline Preference-Based Re.md" --level full`
