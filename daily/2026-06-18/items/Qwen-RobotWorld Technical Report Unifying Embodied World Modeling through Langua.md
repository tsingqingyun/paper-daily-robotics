...
`python3 scripts/start_ai_deep_read.py --vault "." --note "30_Updates/2026-06-18/Qwen-RobotWorld Technical Report Unifying Embodied World Modeling through Langua.md" --level full`
