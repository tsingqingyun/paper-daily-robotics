...
`python3 scripts/start_ai_deep_read.py --vault "." --note "30_Updates/2026-06-18/Memory as a Wasting Asset Pricing Flash Endurance for Embodied Agents, and the L.md" --level full`
