...
`python3 scripts/start_ai_deep_read.py --vault "." --note "30_Updates/2026-06-18/ThinkingVLA Interleaved Vision and Language Reasoning for Robotic Manipulation.md" --level full`
