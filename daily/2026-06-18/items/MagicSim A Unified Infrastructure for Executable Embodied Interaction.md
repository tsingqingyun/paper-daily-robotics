...
`python3 scripts/start_ai_deep_read.py --vault "." --note "30_Updates/2026-06-18/MagicSim A Unified Infrastructure for Executable Embodied Interaction.md" --level full`
