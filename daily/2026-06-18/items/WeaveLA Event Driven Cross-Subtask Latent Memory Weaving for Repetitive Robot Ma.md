...
`python3 scripts/start_ai_deep_read.py --vault "." --note "30_Updates/2026-06-18/WeaveLA Event Driven Cross-Subtask Latent Memory Weaving for Repetitive Robot Ma.md" --level full`
