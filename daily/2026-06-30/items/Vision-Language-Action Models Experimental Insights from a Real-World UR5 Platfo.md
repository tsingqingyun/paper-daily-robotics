...
`python3 scripts/start_ai_deep_read.py --vault "." --note "30_Updates/2026-06-30/Vision-Language-Action Models Experimental Insights from a Real-World UR5 Platfo.md" --level full`
