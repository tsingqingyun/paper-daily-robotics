...
`python3 scripts/start_ai_deep_read.py --vault "." --note "30_Updates/2026-06-30/Grasp-Oriented Non-Prehensile Manipulation via Learning a Graspability Field.md" --level full`
