...
`python3 scripts/start_ai_deep_read.py --vault "." --note "30_Updates/2026-06-30/Behavior Uncloning Distilling Mode Redirection into Policy Weights without Infer.md" --level full`
