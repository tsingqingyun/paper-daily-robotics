...
`python3 scripts/start_ai_deep_read.py --vault "." --note "30_Updates/2026-06-30/OmniCoT A Benchmark for Global and Multi-Step Panoramic Reasoning.md" --level full`
