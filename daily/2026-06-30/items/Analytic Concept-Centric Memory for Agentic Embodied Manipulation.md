...
`python3 scripts/start_ai_deep_read.py --vault "." --note "30_Updates/2026-06-30/Analytic Concept-Centric Memory for Agentic Embodied Manipulation.md" --level full`
