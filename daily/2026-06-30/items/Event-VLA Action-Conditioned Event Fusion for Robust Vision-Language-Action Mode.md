...
`python3 scripts/start_ai_deep_read.py --vault "." --note "30_Updates/2026-06-30/Event-VLA Action-Conditioned Event Fusion for Robust Vision-Language-Action Mode.md" --level full`
