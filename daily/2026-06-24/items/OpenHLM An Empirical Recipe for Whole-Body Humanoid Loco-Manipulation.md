...
`python3 scripts/start_ai_deep_read.py --vault "." --note "30_Updates/2026-06-24/OpenHLM An Empirical Recipe for Whole-Body Humanoid Loco-Manipulation.md" --level full`
