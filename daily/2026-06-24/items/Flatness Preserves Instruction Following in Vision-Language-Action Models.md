...
`python3 scripts/start_ai_deep_read.py --vault "." --note "30_Updates/2026-06-24/Flatness Preserves Instruction Following in Vision-Language-Action Models.md" --level full`
