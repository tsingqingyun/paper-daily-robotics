...
`python3 scripts/start_ai_deep_read.py --vault "." --note "30_Updates/2026-06-24/Wh0 Generative World Models as Scalable Sources of Egocentric Human Hand Manipul.md" --level full`
