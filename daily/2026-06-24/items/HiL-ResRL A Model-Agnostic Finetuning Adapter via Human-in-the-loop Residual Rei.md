...
`python3 scripts/start_ai_deep_read.py --vault "." --note "30_Updates/2026-06-24/HiL-ResRL A Model-Agnostic Finetuning Adapter via Human-in-the-loop Residual Rei.md" --level full`
