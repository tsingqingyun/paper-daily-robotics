...
`python3 scripts/start_ai_deep_read.py --vault "." --note "30_Updates/2026-06-24/HoloAgent-0 A Unified Embodied Agent Framework with 3D Spatial Memory.md" --level full`
