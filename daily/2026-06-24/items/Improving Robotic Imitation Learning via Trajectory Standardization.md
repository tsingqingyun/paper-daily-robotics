...
`python3 scripts/start_ai_deep_read.py --vault "." --note "30_Updates/2026-06-24/Improving Robotic Imitation Learning via Trajectory Standardization.md" --level full`
