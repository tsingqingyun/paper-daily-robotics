...
`python3 scripts/start_ai_deep_read.py --vault "." --note "30_Updates/2026-06-24/HERCULES An Open-Source Simulation Framework for Heterogeneous Multi-Robot SLAM,.md" --level full`
