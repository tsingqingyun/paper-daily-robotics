...
`python3 scripts/start_ai_deep_read.py --vault "." --note "30_Updates/2026-05-26/FOUND-IT Foundation-model-first Task-driven 3D Scene Graphs with Granularity on.md" --level full`
