...
`python3 scripts/start_ai_deep_read.py --vault "." --note "30_Updates/2026-05-26/RepSAM Bridging Foundation Models to Robotic Vision via Representation-Guided Ad.md" --level full`
