...
`python3 scripts/start_ai_deep_read.py --vault "." --note "30_Updates/2026-05-26/EXPO-FT Sample-Efficient Reinforcement Learning Finetuning for Vision-Language-A.md" --level full`
