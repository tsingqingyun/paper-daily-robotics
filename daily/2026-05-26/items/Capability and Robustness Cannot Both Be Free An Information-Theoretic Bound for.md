...
`python3 scripts/start_ai_deep_read.py --vault "." --note "30_Updates/2026-05-26/Capability and Robustness Cannot Both Be Free An Information-Theoretic Bound for.md" --level full`
