...
`python3 scripts/start_ai_deep_read.py --vault "." --note "30_Updates/2026-05-26/Hylos Operability Contracts for Model-Native Spatial Intelligence.md" --level full`
