...
`python3 scripts/start_ai_deep_read.py --vault "." --note "30_Updates/2026-05-26/TapSampling Inference-Time Sampling with a Task-Progress-Understanding Verifier.md" --level full`
