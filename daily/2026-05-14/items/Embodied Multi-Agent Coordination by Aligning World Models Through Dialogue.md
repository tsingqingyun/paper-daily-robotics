...
`python3 scripts/start_ai_deep_read.py --vault "." --note "30_Updates/2026-05-14/Embodied Multi-Agent Coordination by Aligning World Models Through Dialogue.md" --level full`
