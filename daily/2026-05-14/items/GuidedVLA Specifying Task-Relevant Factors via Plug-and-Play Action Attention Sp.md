...
`python3 scripts/start_ai_deep_read.py --vault "." --note "30_Updates/2026-05-14/GuidedVLA Specifying Task-Relevant Factors via Plug-and-Play Action Attention Sp.md" --level full`
