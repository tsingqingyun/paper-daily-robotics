...
`python3 scripts/start_ai_deep_read.py --vault "." --note "30_Updates/2026-05-14/Guide, Think, Act Interactive Embodied Reasoning in Vision-Language-Action Model.md" --level full`
