...
`python3 scripts/start_ai_deep_read.py --vault "." --note "30_Updates/2026-05-14/Learning POMDP World Models from Observations with Language-Model Priors.md" --level full`
