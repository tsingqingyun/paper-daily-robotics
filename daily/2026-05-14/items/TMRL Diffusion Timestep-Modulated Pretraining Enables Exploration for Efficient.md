...
`python3 scripts/start_ai_deep_read.py --vault "." --note "30_Updates/2026-05-14/TMRL Diffusion Timestep-Modulated Pretraining Enables Exploration for Efficient.md" --level full`
