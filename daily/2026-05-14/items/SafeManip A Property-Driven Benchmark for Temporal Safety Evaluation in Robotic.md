...
`python3 scripts/start_ai_deep_read.py --vault "." --note "30_Updates/2026-05-14/SafeManip A Property-Driven Benchmark for Temporal Safety Evaluation in Robotic.md" --level full`
