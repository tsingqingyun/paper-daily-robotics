...
`python3 scripts/start_ai_deep_read.py --vault "." --note "30_Updates/2026-07-17/UESF-Bench Benchmarking and Probing for Unified Embodied Seeking and Following.md" --level full`
