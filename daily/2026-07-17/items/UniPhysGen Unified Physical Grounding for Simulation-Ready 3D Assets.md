...
`python3 scripts/start_ai_deep_read.py --vault "." --note "30_Updates/2026-07-17/UniPhysGen Unified Physical Grounding for Simulation-Ready 3D Assets.md" --level full`
