...
`python3 scripts/start_ai_deep_read.py --vault "." --note "30_Updates/2026-07-17/Learning Safe Agent Behaviour from Human Preferences and Justifications via Worl.md" --level full`
