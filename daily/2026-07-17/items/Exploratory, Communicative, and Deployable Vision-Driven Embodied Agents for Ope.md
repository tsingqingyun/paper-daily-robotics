...
`python3 scripts/start_ai_deep_read.py --vault "." --note "30_Updates/2026-07-17/Exploratory, Communicative, and Deployable Vision-Driven Embodied Agents for Ope.md" --level full`
