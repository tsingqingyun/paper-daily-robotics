...
`python3 scripts/start_ai_deep_read.py --vault "." --note "30_Updates/2026-07-17/FlowWAM Optical Flow as a Unified Action Representation for World Action Models.md" --level full`
