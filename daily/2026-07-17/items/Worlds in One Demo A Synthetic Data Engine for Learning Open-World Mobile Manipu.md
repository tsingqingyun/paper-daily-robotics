...
`python3 scripts/start_ai_deep_read.py --vault "." --note "30_Updates/2026-07-17/Worlds in One Demo A Synthetic Data Engine for Learning Open-World Mobile Manipu.md" --level full`
