...
`python3 scripts/start_ai_deep_read.py --vault "." --note "30_Updates/2026-06-08/PhyRoGen Synthetic Generation of Physical Robot Manipulation Puzzles Using Proce.md" --level full`
