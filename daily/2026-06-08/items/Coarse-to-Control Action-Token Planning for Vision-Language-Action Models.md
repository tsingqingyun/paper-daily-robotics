...
`python3 scripts/start_ai_deep_read.py --vault "." --note "30_Updates/2026-06-08/Coarse-to-Control Action-Token Planning for Vision-Language-Action Models.md" --level full`
