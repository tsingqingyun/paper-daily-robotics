...
`python3 scripts/start_ai_deep_read.py --vault "." --note "30_Updates/2026-06-08/WorldFly A World-Model-Based Vision-Language-Action Model for UAV Navigation.md" --level full`
