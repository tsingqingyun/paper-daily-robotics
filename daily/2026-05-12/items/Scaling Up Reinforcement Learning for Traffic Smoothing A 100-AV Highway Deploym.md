...
`python3 scripts/start_ai_deep_read.py --vault "." --note "30_Updates/2026-05-12/Scaling Up Reinforcement Learning for Traffic Smoothing A 100-AV Highway Deploym.md" --level full`
