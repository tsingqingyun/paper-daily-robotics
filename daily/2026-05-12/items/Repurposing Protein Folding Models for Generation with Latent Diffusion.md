...
`python3 scripts/start_ai_deep_read.py --vault "." --note "30_Updates/2026-05-12/Repurposing Protein Folding Models for Generation with Latent Diffusion.md" --level full`
