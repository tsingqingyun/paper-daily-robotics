...
`python3 scripts/start_ai_deep_read.py --vault "." --note "30_Updates/2026-05-20/SceneCode Executable World Programs for Editable Indoor Scenes with Articulated.md" --level full`
