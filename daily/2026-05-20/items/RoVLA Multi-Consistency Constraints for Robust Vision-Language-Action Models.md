...
`python3 scripts/start_ai_deep_read.py --vault "." --note "30_Updates/2026-05-20/RoVLA Multi-Consistency Constraints for Robust Vision-Language-Action Models.md" --level full`
