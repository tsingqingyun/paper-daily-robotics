...
`python3 scripts/start_ai_deep_read.py --vault "." --note "30_Updates/2026-05-20/On Improving Multimodal Pedestrian Trajectory Prediction with CVAE A Study on Be.md" --level full`
