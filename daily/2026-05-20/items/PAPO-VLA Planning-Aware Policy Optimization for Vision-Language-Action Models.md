...
`python3 scripts/start_ai_deep_read.py --vault "." --note "30_Updates/2026-05-20/PAPO-VLA Planning-Aware Policy Optimization for Vision-Language-Action Models.md" --level full`
