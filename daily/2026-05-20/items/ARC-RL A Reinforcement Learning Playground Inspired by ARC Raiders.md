...
`python3 scripts/start_ai_deep_read.py --vault "." --note "30_Updates/2026-05-20/ARC-RL A Reinforcement Learning Playground Inspired by ARC Raiders.md" --level full`
