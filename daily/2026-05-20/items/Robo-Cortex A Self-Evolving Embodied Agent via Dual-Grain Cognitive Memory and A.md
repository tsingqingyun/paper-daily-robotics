...
`python3 scripts/start_ai_deep_read.py --vault "." --note "30_Updates/2026-05-20/Robo-Cortex A Self-Evolving Embodied Agent via Dual-Grain Cognitive Memory and A.md" --level full`
