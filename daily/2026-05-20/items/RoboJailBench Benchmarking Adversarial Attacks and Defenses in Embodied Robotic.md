...
`python3 scripts/start_ai_deep_read.py --vault "." --note "30_Updates/2026-05-20/RoboJailBench Benchmarking Adversarial Attacks and Defenses in Embodied Robotic.md" --level full`
