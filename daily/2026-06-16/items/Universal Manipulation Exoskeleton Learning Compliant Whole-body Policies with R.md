...
`python3 scripts/start_ai_deep_read.py --vault "." --note "30_Updates/2026-06-16/Universal Manipulation Exoskeleton Learning Compliant Whole-body Policies with R.md" --level full`
