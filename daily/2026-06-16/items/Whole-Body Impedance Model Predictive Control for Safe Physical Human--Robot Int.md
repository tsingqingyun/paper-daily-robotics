...
`python3 scripts/start_ai_deep_read.py --vault "." --note "30_Updates/2026-06-16/Whole-Body Impedance Model Predictive Control for Safe Physical Human--Robot Int.md" --level full`
