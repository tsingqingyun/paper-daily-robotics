...
`python3 scripts/start_ai_deep_read.py --vault "." --note "30_Updates/2026-06-16/Causal Object-Centric Models for Planning with Monte Carlo Tree Search.md" --level full`
