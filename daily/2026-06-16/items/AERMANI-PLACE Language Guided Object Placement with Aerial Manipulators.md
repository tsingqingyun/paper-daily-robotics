...
`python3 scripts/start_ai_deep_read.py --vault "." --note "30_Updates/2026-06-16/AERMANI-PLACE Language Guided Object Placement with Aerial Manipulators.md" --level full`
