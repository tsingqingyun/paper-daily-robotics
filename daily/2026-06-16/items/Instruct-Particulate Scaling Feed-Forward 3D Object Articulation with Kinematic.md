...
`python3 scripts/start_ai_deep_read.py --vault "." --note "30_Updates/2026-06-16/Instruct-Particulate Scaling Feed-Forward 3D Object Articulation with Kinematic.md" --level full`
