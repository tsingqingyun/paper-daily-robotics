...
url: "https://arxiv.org/abs/2608.17453v2"
...
`python3 scripts/start_ai_deep_read.py --vault "." --note "30_Updates/2026-08-21/EATR-Stereo Embodiment-Aware Token Routing of Paired Stereo Evidence for Humanoi.md" --level full`
