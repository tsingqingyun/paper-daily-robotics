...
`python3 scripts/start_ai_deep_read.py --vault "." --note "30_Updates/2026-07-03/Neuro-Symbolic Safety Guidance for Vision-Language-Action Models via Constrained.md" --level full`
