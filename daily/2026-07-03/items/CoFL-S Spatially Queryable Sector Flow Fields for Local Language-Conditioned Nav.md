...
`python3 scripts/start_ai_deep_read.py --vault "." --note "30_Updates/2026-07-03/CoFL-S Spatially Queryable Sector Flow Fields for Local Language-Conditioned Nav.md" --level full`
