...
`python3 scripts/start_ai_deep_read.py --vault "." --note "30_Updates/2026-07-03/Embodied.cpp A Portable Inference Runtime of Embodied AI Models on Heterogeneous.md" --level full`
