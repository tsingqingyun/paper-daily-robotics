...
`python3 scripts/start_ai_deep_read.py --vault "." --note "30_Updates/2026-07-03/From Forgeries to Foundation Models A Systematic Survey of Identity Document Att.md" --level full`
