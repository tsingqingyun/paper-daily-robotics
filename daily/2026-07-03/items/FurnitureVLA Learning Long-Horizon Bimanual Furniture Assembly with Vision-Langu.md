...
`python3 scripts/start_ai_deep_read.py --vault "." --note "30_Updates/2026-07-03/FurnitureVLA Learning Long-Horizon Bimanual Furniture Assembly with Vision-Langu.md" --level full`
