...
`python3 scripts/start_ai_deep_read.py --vault "." --note "30_Updates/2026-07-03/ComplexMimic Human-Scene Interaction Imitation in Complex 3D Environments.md" --level full`
