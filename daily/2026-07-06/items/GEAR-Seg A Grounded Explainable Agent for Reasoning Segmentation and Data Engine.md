...
`python3 scripts/start_ai_deep_read.py --vault "." --note "30_Updates/2026-07-06/GEAR-Seg A Grounded Explainable Agent for Reasoning Segmentation and Data Engine.md" --level full`
