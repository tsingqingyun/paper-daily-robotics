...
`python3 scripts/start_ai_deep_read.py --vault "." --note "30_Updates/2026-07-06/Task-Relevant Representation Decoupling for Visual Reinforcement Learning Genera.md" --level full`
