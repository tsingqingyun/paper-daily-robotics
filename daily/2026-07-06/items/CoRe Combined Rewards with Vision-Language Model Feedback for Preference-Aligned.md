...
`python3 scripts/start_ai_deep_read.py --vault "." --note "30_Updates/2026-07-06/CoRe Combined Rewards with Vision-Language Model Feedback for Preference-Aligned.md" --level full`
