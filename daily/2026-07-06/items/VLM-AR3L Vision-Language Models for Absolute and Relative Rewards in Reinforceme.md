...
`python3 scripts/start_ai_deep_read.py --vault "." --note "30_Updates/2026-07-06/VLM-AR3L Vision-Language Models for Absolute and Relative Rewards in Reinforceme.md" --level full`
