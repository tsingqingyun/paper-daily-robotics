...
`python3 scripts/start_ai_deep_read.py --vault "." --note "30_Updates/2026-07-06/ACID Action Consistency via Inverse Dynamics for Planning with World Models.md" --level full`
