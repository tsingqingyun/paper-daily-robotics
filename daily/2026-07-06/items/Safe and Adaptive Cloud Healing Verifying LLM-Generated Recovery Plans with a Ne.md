...
`python3 scripts/start_ai_deep_read.py --vault "." --note "30_Updates/2026-07-06/Safe and Adaptive Cloud Healing Verifying LLM-Generated Recovery Plans with a Ne.md" --level full`
