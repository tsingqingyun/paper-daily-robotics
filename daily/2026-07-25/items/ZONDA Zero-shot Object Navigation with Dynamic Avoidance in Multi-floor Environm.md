...
`python3 scripts/start_ai_deep_read.py --vault "." --note "30_Updates/2026-07-25/ZONDA Zero-shot Object Navigation with Dynamic Avoidance in Multi-floor Environm.md" --level full`
