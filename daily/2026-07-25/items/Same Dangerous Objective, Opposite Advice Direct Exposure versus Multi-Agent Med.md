...
`python3 scripts/start_ai_deep_read.py --vault "." --note "30_Updates/2026-07-25/Same Dangerous Objective, Opposite Advice Direct Exposure versus Multi-Agent Med.md" --level full`
