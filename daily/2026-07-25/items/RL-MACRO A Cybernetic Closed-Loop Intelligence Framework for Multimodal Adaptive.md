...
`python3 scripts/start_ai_deep_read.py --vault "." --note "30_Updates/2026-07-25/RL-MACRO A Cybernetic Closed-Loop Intelligence Framework for Multimodal Adaptive.md" --level full`
