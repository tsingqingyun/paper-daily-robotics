...
`python3 scripts/start_ai_deep_read.py --vault "." --note "30_Updates/2026-07-25/SOPD-SocialNav Selective On-Policy Distillation for Vision-Language Social Navig.md" --level full`
