...
`python3 scripts/start_ai_deep_read.py --vault "." --note "30_Updates/2026-06-12/DuoBench A Reproducible Benchmark for Bimanual Manipulation in Simulation and th.md" --level full`
