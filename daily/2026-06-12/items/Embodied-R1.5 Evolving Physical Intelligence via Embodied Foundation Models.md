...
`python3 scripts/start_ai_deep_read.py --vault "." --note "30_Updates/2026-06-12/Embodied-R1.5 Evolving Physical Intelligence via Embodied Foundation Models.md" --level full`
