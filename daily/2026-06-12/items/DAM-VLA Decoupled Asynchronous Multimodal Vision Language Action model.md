...
`python3 scripts/start_ai_deep_read.py --vault "." --note "30_Updates/2026-06-12/DAM-VLA Decoupled Asynchronous Multimodal Vision Language Action model.md" --level full`
