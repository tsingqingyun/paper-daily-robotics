...
`python3 scripts/start_ai_deep_read.py --vault "." --note "30_Updates/2026-06-10/VeriSpace Spatially Grounded Action Verification for Vision-Language-Action Mode.md" --level full`
