...
`python3 scripts/start_ai_deep_read.py --vault "." --note "30_Updates/2026-06-10/SARM2 Multi-Task Stage Aware Reward Modeling for Self Improving Robotic Manipula.md" --level full`
