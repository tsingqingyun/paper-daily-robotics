...
`python3 scripts/start_ai_deep_read.py --vault "." --note "30_Updates/2026-06-10/IMPACT Learning Internal-Model Predictive Control for Forceful Robotic Manipulat.md" --level full`
