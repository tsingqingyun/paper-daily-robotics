...
`python3 scripts/start_ai_deep_read.py --vault "." --note "30_Updates/2026-06-10/MotionWAM Towards Foundation World Action Models for Real-Time Humanoid Loco-Man.md" --level full`
