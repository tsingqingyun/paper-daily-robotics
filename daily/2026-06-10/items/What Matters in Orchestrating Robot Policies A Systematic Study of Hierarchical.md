...
`python3 scripts/start_ai_deep_read.py --vault "." --note "30_Updates/2026-06-10/What Matters in Orchestrating Robot Policies A Systematic Study of Hierarchical.md" --level full`
