...
`python3 scripts/start_ai_deep_read.py --vault "." --note "30_Updates/2026-06-10/Your Model Already Knows Attention-Guided Safety Filter for Vision-Language-Acti.md" --level full`
