...
`python3 scripts/start_ai_deep_read.py --vault "." --note "30_Updates/2026-06-10/LIBERO-Occ Evaluating and Improving Vision-Language-Action Models under Scene-In.md" --level full`
