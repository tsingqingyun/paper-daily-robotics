...
`python3 scripts/start_ai_deep_read.py --vault "." --note "30_Updates/2026-06-10/Harness Engineering for Physical AI Robot Middleware Is the Harness Layer.md" --level full`
