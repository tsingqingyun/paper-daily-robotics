...
`python3 scripts/start_ai_deep_read.py --vault "." --note "30_Updates/2026-06-10/TORL-VLA Tactile Guided Online Reinforcement Learning for Contact-Rich Manipulat.md" --level full`
