...
`python3 scripts/start_ai_deep_read.py --vault "." --note "30_Updates/2026-06-25/G$ 3$VLA Geometric inductive bias for Vision-Language-Action Models.md" --level full`
