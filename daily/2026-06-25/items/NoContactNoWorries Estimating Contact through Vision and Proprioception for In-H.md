...
`python3 scripts/start_ai_deep_read.py --vault "." --note "30_Updates/2026-06-25/NoContactNoWorries Estimating Contact through Vision and Proprioception for In-H.md" --level full`
