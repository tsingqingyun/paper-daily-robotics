...
`python3 scripts/start_ai_deep_read.py --vault "." --note "30_Updates/2026-06-25/Compact Object-Level Representations with Open-Vocabulary Understanding for Indo.md" --level full`
