...
`python3 scripts/start_ai_deep_read.py --vault "." --note "30_Updates/2026-06-25/Intend, Reflect, Refine An Adaptive Multimodal Reflection Framework for Autonomo.md" --level full`
