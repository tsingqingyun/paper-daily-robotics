...
`python3 scripts/start_ai_deep_read.py --vault "." --note "30_Updates/2026-06-25/Flow as Flow Modeling Robot Velocity Fields as Probability Velocity Fields for F.md" --level full`
