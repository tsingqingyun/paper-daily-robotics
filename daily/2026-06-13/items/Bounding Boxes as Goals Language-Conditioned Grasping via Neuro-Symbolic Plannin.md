...
`python3 scripts/start_ai_deep_read.py --vault "." --note "30_Updates/2026-06-13/Bounding Boxes as Goals Language-Conditioned Grasping via Neuro-Symbolic Plannin.md" --level full`
