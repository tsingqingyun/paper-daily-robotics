...
`python3 scripts/start_ai_deep_read.py --vault "." --note "30_Updates/2026-06-13/LabVLA Grounding Vision-Language-Action Models in Scientific Laboratories.md" --level full`
