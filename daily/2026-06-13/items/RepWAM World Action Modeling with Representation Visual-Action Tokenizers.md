...
`python3 scripts/start_ai_deep_read.py --vault "." --note "30_Updates/2026-06-13/RepWAM World Action Modeling with Representation Visual-Action Tokenizers.md" --level full`
