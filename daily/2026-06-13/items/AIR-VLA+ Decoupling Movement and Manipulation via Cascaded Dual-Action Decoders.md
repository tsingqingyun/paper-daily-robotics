...
`python3 scripts/start_ai_deep_read.py --vault "." --note "30_Updates/2026-06-13/AIR-VLA+ Decoupling Movement and Manipulation via Cascaded Dual-Action Decoders.md" --level full`
