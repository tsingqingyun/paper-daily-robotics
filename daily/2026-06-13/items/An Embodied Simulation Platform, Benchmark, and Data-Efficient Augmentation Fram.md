...
`python3 scripts/start_ai_deep_read.py --vault "." --note "30_Updates/2026-06-13/An Embodied Simulation Platform, Benchmark, and Data-Efficient Augmentation Fram.md" --level full`
