...
`python3 scripts/start_ai_deep_read.py --vault "." --note "30_Updates/2026-07-24/URF A Unified Robot Control-Policy Framework for Stable Contact Aware Manipulati.md" --level full`
