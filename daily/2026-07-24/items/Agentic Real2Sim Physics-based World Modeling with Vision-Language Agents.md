...
`python3 scripts/start_ai_deep_read.py --vault "." --note "30_Updates/2026-07-24/Agentic Real2Sim Physics-based World Modeling with Vision-Language Agents.md" --level full`
...
evaluation. The project site is available at https://agentic-real2sim.github.io/.
