...
`python3 scripts/start_ai_deep_read.py --vault "." --note "30_Updates/2026-07-24/RoboInter1.5 A Holistic Intermediate Representation Suite for Embodied World Mod.md" --level full`
