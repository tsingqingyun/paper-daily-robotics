...
`python3 scripts/start_ai_deep_read.py --vault "." --note "30_Updates/2026-07-24/ODeform Learning Continuous 4D Motion for Shape Deformation with Neural ODEs.md" --level full`
