...
`python3 scripts/start_ai_deep_read.py --vault "." --note "30_Updates/2026-07-24/TransBiolab A Real-World Multi-View Dataset of Cluttered Transparent Biomedical.md" --level full`
