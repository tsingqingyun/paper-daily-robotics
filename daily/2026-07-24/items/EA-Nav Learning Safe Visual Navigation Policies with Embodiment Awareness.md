...
`python3 scripts/start_ai_deep_read.py --vault "." --note "30_Updates/2026-07-24/EA-Nav Learning Safe Visual Navigation Policies with Embodiment Awareness.md" --level full`
