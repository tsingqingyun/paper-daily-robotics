...
`python3 scripts/start_ai_deep_read.py --vault "." --note "30_Updates/2026-07-24/NavVerse Benchmarking Indoor-to-Outdoor Embodied Navigation in Continuous Robot.md" --level full`
