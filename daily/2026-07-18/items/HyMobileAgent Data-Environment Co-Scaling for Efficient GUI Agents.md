...
`python3 scripts/start_ai_deep_read.py --vault "." --note "30_Updates/2026-07-18/HyMobileAgent Data-Environment Co-Scaling for Efficient GUI Agents.md" --level full`
