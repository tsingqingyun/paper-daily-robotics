...
`python3 scripts/start_ai_deep_read.py --vault "." --note "30_Updates/2026-07-18/AeroAct Action-Centered World-Action Models for Language-Conditioned Quadrotor F.md" --level full`
