...
`python3 scripts/start_ai_deep_read.py --vault "." --note "30_Updates/2026-07-18/VTM-Nav Hierarchical Visual-Topological Memory for Cross-Episode Object-Goal Nav.md" --level full`
