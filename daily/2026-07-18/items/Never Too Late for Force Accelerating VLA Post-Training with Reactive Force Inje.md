...
`python3 scripts/start_ai_deep_read.py --vault "." --note "30_Updates/2026-07-18/Never Too Late for Force Accelerating VLA Post-Training with Reactive Force Inje.md" --level full`
