...
`python3 scripts/start_ai_deep_read.py --vault "." --note "30_Updates/2026-07-18/SafeRelBench A Spatial-Relation-Aware Benchmark for Process-Level Safety in VLM-.md" --level full`
