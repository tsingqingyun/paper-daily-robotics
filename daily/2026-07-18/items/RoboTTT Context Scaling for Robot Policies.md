...
- **问题**：Recent robot foundation models operate with single-step or short-history visuomotor context.
...
`python3 scripts/start_ai_deep_read.py --vault "." --note "30_Updates/2026-07-18/RoboTTT Context Scaling for Robot Policies.md" --level full`
