...
`python3 scripts/start_ai_deep_read.py --vault "." --note "30_Updates/2026-07-18/Multimodality as Supervision Self-Supervised Specialization to the Test Environm.md" --level full`
