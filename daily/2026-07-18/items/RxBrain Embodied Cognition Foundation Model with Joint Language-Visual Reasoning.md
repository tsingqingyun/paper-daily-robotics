...
`python3 scripts/start_ai_deep_read.py --vault "." --note "30_Updates/2026-07-18/RxBrain Embodied Cognition Foundation Model with Joint Language-Visual Reasoning.md" --level full`
