...
`python3 scripts/start_ai_deep_read.py --vault "." --note "30_Updates/2026-08-10/Robot Learning from Human Demonstrations Handwritten Alphabet Trajectories and H.md" --level full`
