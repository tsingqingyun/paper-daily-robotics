...
`python3 scripts/start_ai_deep_read.py --vault "." --note "30_Updates/2026-08-10/Detection and Ranging of Transient Extrinsic Contacts Based on 6D Dynamic Tactil.md" --level full`
