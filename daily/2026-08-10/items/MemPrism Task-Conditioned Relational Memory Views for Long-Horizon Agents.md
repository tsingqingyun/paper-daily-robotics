...
`python3 scripts/start_ai_deep_read.py --vault "." --note "30_Updates/2026-08-10/MemPrism Task-Conditioned Relational Memory Views for Long-Horizon Agents.md" --level full`
