...
`python3 scripts/start_ai_deep_read.py --vault "." --note "30_Updates/2026-08-10/VIDP Variable Impedance Diffusion Policy for Compliant Robot Manipulation from D.md" --level full`
