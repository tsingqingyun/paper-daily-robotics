...
`python3 scripts/start_ai_deep_read.py --vault "." --note "30_Updates/2026-08-10/Surg-UniWorld A Unified Surgical World Model with Multimodal Control Experts.md" --level full`
