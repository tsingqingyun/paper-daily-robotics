...
`python3 scripts/start_ai_deep_read.py --vault "." --note "30_Updates/2026-05-10/Learning while Deploying Fleet-Scale Reinforcement Learning for Generalist Robot.md" --level full`
