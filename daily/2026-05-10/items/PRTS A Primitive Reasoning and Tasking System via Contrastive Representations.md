...
`python3 scripts/start_ai_deep_read.py --vault "." --note "30_Updates/2026-05-10/PRTS A Primitive Reasoning and Tasking System via Contrastive Representations.md" --level full`
