...
`python3 scripts/start_ai_deep_read.py --vault "." --note "30_Updates/2026-05-10/TriRelVLA Triadic Relational Structure for Generalizable Embodied Manipulation.md" --level full`
