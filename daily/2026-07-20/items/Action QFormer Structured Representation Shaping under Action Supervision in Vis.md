...
`python3 scripts/start_ai_deep_read.py --vault "." --note "30_Updates/2026-07-20/Action QFormer Structured Representation Shaping under Action Supervision in Vis.md" --level full`
