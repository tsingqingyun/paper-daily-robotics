...
`python3 scripts/start_ai_deep_read.py --vault "." --note "30_Updates/2026-07-20/VTLoc Learning-based Tactile Contact Localization in Visual Point Clouds.md" --level full`
