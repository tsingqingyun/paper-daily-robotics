...
`python3 scripts/start_ai_deep_read.py --vault "." --note "30_Updates/2026-07-20/PIXIE A Zero-Shot texture-invariant 6D pose estimation framework for unseen obje.md" --level full`
