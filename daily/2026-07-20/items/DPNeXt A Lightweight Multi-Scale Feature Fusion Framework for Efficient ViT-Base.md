...
`python3 scripts/start_ai_deep_read.py --vault "." --note "30_Updates/2026-07-20/DPNeXt A Lightweight Multi-Scale Feature Fusion Framework for Efficient ViT-Base.md" --level full`
