...
`python3 scripts/start_ai_deep_read.py --vault "." --note "30_Updates/2026-07-20/Exo2EgoPose Leveraging Exocentric Demonstrations for Vision-Language guided Egoc.md" --level full`
