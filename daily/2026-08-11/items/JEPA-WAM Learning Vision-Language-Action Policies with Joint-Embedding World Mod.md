...
`python3 scripts/start_ai_deep_read.py --vault "." --note "30_Updates/2026-08-11/JEPA-WAM Learning Vision-Language-Action Policies with Joint-Embedding World Mod.md" --level full`
