...
`python3 scripts/start_ai_deep_read.py --vault "." --note "30_Updates/2026-08-11/Trajectory Divergence Horizon Decision for Reliable Dual-Arm Surgical Subtask Ma.md" --level full`
