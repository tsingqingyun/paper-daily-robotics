...
`python3 scripts/start_ai_deep_read.py --vault "." --note "30_Updates/2026-08-11/Compiling and Benchmarking Task-State Horizons for Embodied Agents.md" --level full`
