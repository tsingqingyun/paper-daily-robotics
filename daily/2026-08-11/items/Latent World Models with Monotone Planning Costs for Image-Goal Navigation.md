...
`python3 scripts/start_ai_deep_read.py --vault "." --note "30_Updates/2026-08-11/Latent World Models with Monotone Planning Costs for Image-Goal Navigation.md" --level full`
