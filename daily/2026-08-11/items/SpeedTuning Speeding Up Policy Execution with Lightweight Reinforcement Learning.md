...
`python3 scripts/start_ai_deep_read.py --vault "." --note "30_Updates/2026-08-11/SpeedTuning Speeding Up Policy Execution with Lightweight Reinforcement Learning.md" --level full`
