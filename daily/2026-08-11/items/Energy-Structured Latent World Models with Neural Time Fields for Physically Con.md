...
`python3 scripts/start_ai_deep_read.py --vault "." --note "30_Updates/2026-08-11/Energy-Structured Latent World Models with Neural Time Fields for Physically Con.md" --level full`
