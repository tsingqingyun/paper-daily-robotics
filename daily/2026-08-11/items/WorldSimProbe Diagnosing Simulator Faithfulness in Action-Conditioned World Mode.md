...
`python3 scripts/start_ai_deep_read.py --vault "." --note "30_Updates/2026-08-11/WorldSimProbe Diagnosing Simulator Faithfulness in Action-Conditioned World Mode.md" --level full`
