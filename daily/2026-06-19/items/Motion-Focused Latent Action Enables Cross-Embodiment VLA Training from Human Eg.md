...
`python3 scripts/start_ai_deep_read.py --vault "." --note "30_Updates/2026-06-19/Motion-Focused Latent Action Enables Cross-Embodiment VLA Training from Human Eg.md" --level full`
