...
`python3 scripts/start_ai_deep_read.py --vault "." --note "30_Updates/2026-06-19/Qwen-RobotManip Technical Report Alignment Unlocks Scale for Robotic Manipulatio.md" --level full`
