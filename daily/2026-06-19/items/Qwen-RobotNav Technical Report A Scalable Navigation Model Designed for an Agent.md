...
`python3 scripts/start_ai_deep_read.py --vault "." --note "30_Updates/2026-06-19/Qwen-RobotNav Technical Report A Scalable Navigation Model Designed for an Agent.md" --level full`
