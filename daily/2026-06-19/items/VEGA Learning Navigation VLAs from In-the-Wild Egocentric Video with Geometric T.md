...
`python3 scripts/start_ai_deep_read.py --vault "." --note "30_Updates/2026-06-19/VEGA Learning Navigation VLAs from In-the-Wild Egocentric Video with Geometric T.md" --level full`
