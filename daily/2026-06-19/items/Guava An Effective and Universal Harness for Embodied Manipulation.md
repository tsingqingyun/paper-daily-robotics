...
`python3 scripts/start_ai_deep_read.py --vault "." --note "30_Updates/2026-06-19/Guava An Effective and Universal Harness for Embodied Manipulation.md" --level full`
