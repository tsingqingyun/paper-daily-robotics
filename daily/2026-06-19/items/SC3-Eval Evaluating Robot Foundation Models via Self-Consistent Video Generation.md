...
`python3 scripts/start_ai_deep_read.py --vault "." --note "30_Updates/2026-06-19/SC3-Eval Evaluating Robot Foundation Models via Self-Consistent Video Generation.md" --level full`
