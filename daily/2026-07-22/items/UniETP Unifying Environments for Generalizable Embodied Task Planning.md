...
`python3 scripts/start_ai_deep_read.py --vault "." --note "30_Updates/2026-07-22/UniETP Unifying Environments for Generalizable Embodied Task Planning.md" --level full`
