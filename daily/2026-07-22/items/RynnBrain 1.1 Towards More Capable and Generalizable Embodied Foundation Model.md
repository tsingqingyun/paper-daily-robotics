...
`python3 scripts/start_ai_deep_read.py --vault "." --note "30_Updates/2026-07-22/RynnBrain 1.1 Towards More Capable and Generalizable Embodied Foundation Model.md" --level full`
