...
`python3 scripts/start_ai_deep_read.py --vault "." --note "30_Updates/2026-07-22/FM-VLA Force-based Memory for Vision-Language-Action Models in Contact-Rich Mani.md" --level full`
