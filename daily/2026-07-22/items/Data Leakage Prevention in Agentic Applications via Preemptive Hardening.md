...
`python3 scripts/start_ai_deep_read.py --vault "." --note "30_Updates/2026-07-22/Data Leakage Prevention in Agentic Applications via Preemptive Hardening.md" --level full`
