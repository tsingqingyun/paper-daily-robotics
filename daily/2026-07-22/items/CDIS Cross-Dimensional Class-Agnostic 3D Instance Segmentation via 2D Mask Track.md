...
`python3 scripts/start_ai_deep_read.py --vault "." --note "30_Updates/2026-07-22/CDIS Cross-Dimensional Class-Agnostic 3D Instance Segmentation via 2D Mask Track.md" --level full`
