...
`python3 scripts/start_ai_deep_read.py --vault "." --note "30_Updates/2026-07-22/WorldScape Policy 2.0 Empowering Steerable World Action Modeling with Reasoning-.md" --level full`
