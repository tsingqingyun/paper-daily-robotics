...
`python3 scripts/start_ai_deep_read.py --vault "." --note "30_Updates/2026-08-12/Agentic Harnesses LLM-Driven Verification Layers for Robot Autonomy.md" --level full`
