...
`python3 scripts/start_ai_deep_read.py --vault "." --note "30_Updates/2026-08-12/SkillsMetric Mapping the Detection Boundary of Static Analysis for Malicious Age.md" --level full`
