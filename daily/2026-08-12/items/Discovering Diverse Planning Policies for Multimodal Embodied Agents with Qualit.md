...
`python3 scripts/start_ai_deep_read.py --vault "." --note "30_Updates/2026-08-12/Discovering Diverse Planning Policies for Multimodal Embodied Agents with Qualit.md" --level full`
