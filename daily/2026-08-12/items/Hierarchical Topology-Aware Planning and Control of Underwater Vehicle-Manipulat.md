...
`python3 scripts/start_ai_deep_read.py --vault "." --note "30_Updates/2026-08-12/Hierarchical Topology-Aware Planning and Control of Underwater Vehicle-Manipulat.md" --level full`
